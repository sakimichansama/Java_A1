...
public class GeneralPractitioner extends HealthProfessional {
    ...
    public GeneralPractitioner(int ID, String name, String basicInfo, String department, String specialization, String professionalDetail) {
    ...
    public void setProfessionalDetail(String professionalDetail) {
        if (professionalDetail == null || professionalDetail.isEmpty()) {
            throw new InvalidParameterException("Professional detail cannot be empty.");
        }
        this.professionalDetail = professionalDetail;
    }
